package today.Sapphire.gui.clickgui.buttons;
...
extends GuiButton {
    ...
    public void drawButton(Minecraft mc2, int mouseX, int mouseY) {
        if (this.visible) {
            ...
            int var6 = -1;
            Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(this.displayString, this.xPosition + this.width / 2, (float)this.yPosition + (float)(this.height - this.font.FONT_HEIGHT) / 2.0f, this.hovered ? -1 : -3487030);
            GL11.glPopAttrib();
            GL11.glPopMatrix();
        }
    }

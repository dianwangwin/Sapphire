...
public class UIMode {
    ...
    public void draw(int mouseX, int mouseY, int x, int y) {
        ...
        font.drawStringWithShadow(value.getModeTitle(), x + 4, y + 3, -1);
        font.drawString(displayText, (float)x + (float)(this.width - font.getStringWidth(displayText)) / 2.0f - font.getStringWidth(modeCountText) / 4f - 3, (float)y + (float)(this.height - font.getHeight()) / 2.0f + 1.5F, -1);

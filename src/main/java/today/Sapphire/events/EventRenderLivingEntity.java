...
public class EventRenderLivingEntity implements Event, Cancellable
{
    ...
    public EventRenderLivingEntity(EntityLivingBase entity, final boolean pre, final float limbSwing, final float limbSwingAmount, final float ageInTicks, final float rotationYawHead, final float rotationPitch, final float chestRot, final float offset) {
        this.entity = entity;
        this.pre = pre;
    ...
    public EventRenderLivingEntity(EntityLivingBase entity, final boolean pre) {
        this.entity = entity;
        this.pre = pre;
    }
